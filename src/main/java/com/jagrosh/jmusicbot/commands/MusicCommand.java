...
public abstract class MusicCommand extends Command 
{
    ...
    protected void execute(CommandEvent event) 
    {
        ...
        if(beListening)
        {
            AudioChannelUnion voiceStateChannel = event.getGuild().getSelfMember().getVoiceState().getChannel();
            VoiceChannel current = voiceStateChannel != null && voiceStateChannel.getType().isAudio() ? voiceStateChannel.asVoiceChannel() : null;
